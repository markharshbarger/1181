/**
 * Represents a truck that has crossed the road and railroad junction
 */
public class TruckCrossing extends Event {
    private int truckNum;

    /**
     * Constructor of TruckCrossing
     * 
     ...
     * 
     * @return the current time with the truck and number and that the truck is crossing the crossing
     */
    @Override
